...
code:
`  # 'parent_directory' is the parent directory of your angular projectr
  cd parent_directory
...
},
{
  ...
  code:
` # 'xxxx' is the port hosting the angular web application (4200 by default), --open to open a browser (optional)
...
`  # !!! stop ng runtime !!!
  ...
  # When prompted, import Fontawesome font libraries as required :
  # Free Solid Icons
  # Free Regular Icons
  # Free Brands Icons
